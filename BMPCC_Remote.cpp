 ...
 * 
 */
void BMPCC_Remote::listServices( BLEClient *pClient )
{
 ...
 * 
 */
BLERemoteService * BMPCC_Remote::connectToService( BLEClient* pClient,  BLEUUID &uuid )
{
 ...
 * 
 */
BLERemoteCharacteristic * BMPCC_Remote::getCharacteristic( BLERemoteService *pCameraInfoSvc,  BLEUUID &uuid )
{
 ...
 * 
 */
void BMPCC_Remote::cameraStatusNotifyCallback( BLERemoteCharacteristic* pBLERemoteCharacteristic, uint8_t* pData, size_t length, bool isNotify )
{
 ...
 * 
 */
void BMPCC_Remote::timecodeNotifyCallback( BLERemoteCharacteristic* pBLERemoteCharacteristic, uint8_t* pData, size_t length, bool isNotify )
{
 ...
 * 
 */
void BMPCC_Remote::cameraInControlNotifyCallback( BLERemoteCharacteristic* pBLERemoteCharacteristic, uint8_t* pData, size_t length, bool isNotify )
{
 ...
 * 
 */
bool BMPCC_Remote::getConnected() 
{
...
void BMPCC_Remote::setRecordState(bool state)
{
  if (!state)
  {
    record[8] = PREVIEW;
